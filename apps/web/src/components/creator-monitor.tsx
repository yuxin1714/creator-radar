...
export function CreatorFeed({today=false}:{today?:boolean}){return <Suspense fallback={<p>正在读取情报…</p>}><FeedContent today={today}/></Suspense>}
