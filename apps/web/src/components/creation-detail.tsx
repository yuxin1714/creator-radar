...
type Brief={platform:string;content_type:string;direction:string;style:string;playbook_id:string};type Generation={id:string;status:string;content:string|null;error_summary:string|null;playbook_id:string;playbook_revision:string|null};type Project={work_id:string|null;output_language:string;id:string;title:string;idea:string|null;status:string;body:string|null;updated_at:string;brief:Brief|null;latest_generation:Generation|null};type Playbook={id:string;name:string;revision:string|null};
